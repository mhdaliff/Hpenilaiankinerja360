    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'dasbor' ? 'active' : '' }}"
                    href="{{ route('dasbor') }}">
                    <div
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'tim-kerja' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Tim Kerja</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'penilaian' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        {{ in_array(request()->route()->getName(),['penilaian']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
