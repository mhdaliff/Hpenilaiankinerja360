                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between position-relative">
                            <div class="container-fluid text-center">
                                <h5 class="mb-0 font-weight-bolder">Daftar Monitoring</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="card card-background move-on-hover shadow-none card-background-mask-warning" id="sidenavCard">
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="row">
                                            ...
                                            <a href="/monitoring/{{$penilaian->id}}" class="card-title h4 d-block text-white mb-3">
                                            ...
                                            <a href="/monitoring/{{$penilaian->id}}" class="btn btn-white btn-sm w-100" type="button">Detail</a>        
                                        </div>
                                    </div>
                                </div>
                            </div>
